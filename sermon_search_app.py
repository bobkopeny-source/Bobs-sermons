...
try:
    with gzip.open('PASTOR_BOB_SERMONS_COMPLETE_CLEAN.json.gz', 'rt', encoding='utf-8') as f:
        SERMONS = json.load(f)
    print(f"✅ Loaded {len(SERMONS)} sermons")
except FileNotFoundError:
    print("❌ ERROR: Sermon database file not found!")
    print("Make sure PASTOR_BOB_SERMONS_COMPLETE_CLEAN.json.gz is in the same directory")
